@{
    ...
    CloseAppsPrompt = @{
        Classic = @{
            WelcomeMessage = @{
                Install = "Bitte beachte, dass es während der Installation zu einem Unterbruch im Zugriff auf interne Ressourcen (etwa Netzlaufwerke) kommt.`n`nDie folgende Anwendung wird installiert:"
                Repair = 'Die folgende Anwendung wird repariert:'
                Uninstall = 'Die folgende Anwendung wird deinstalliert:'
            }
            CloseAppsMessage = @{
                Install = "Bitte beachte, dass es während der Installation zu einem Unterbruch im Zugriff auf interne Ressourcen (etwa Netzlaufwerke) kommt.`n`nDie folgenden Anwendungen müssen geschlossen werden, bevor die Installation fortgesetzt werden kann.`n`nBitte speichern Sie Ihre Arbeit, schließen Sie die Anwendungen und fahren dann fort. Alternativ können Sie Ihre Arbeit speichern und auf `„Anwendungen schließen`“ klicken."
        ...
        Fluent = @{
            DialogMessage = @{
                Install = "Bitte beachte, dass es während der Installation zu einem Unterbruch im Zugriff auf interne Ressourcen (etwa Netzlaufwerke) kommt.`n`nBitte speichern Sie Ihre Arbeit, bevor Sie fortfahren, da die folgenden Anwendungen automatisch geschlossen werden."
            ...
            DialogMessageNoProcesses = @{
                Install = "Bitte beachte, dass es während der Installation zu einem Unterbruch im Zugriff auf interne Ressourcen (etwa Netzlaufwerke) kommt.`n`nWählen Sie Installieren aus, um mit der Installation fortzufahren."
