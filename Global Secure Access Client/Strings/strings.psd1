@{
    ...
    CloseAppsPrompt = @{
        Classic = @{
            ...
            WelcomeMessage = @{
                Install = "Please be aware of disconnection to ressources such as network shares during install.`n`nThe following application is about to be installed:"
            ...
            CloseAppsMessage = @{
                Install = "Please be aware of disconnection to ressources such as network shares during install.`n`nThe following programs must be closed before the installation can proceed.`n`nPlease save your work, close the programs, and then continue. Alternatively, save your work and click `"Close Programs`"."
        ...
        Fluent = @{
            ...
            DialogMessage = @{
                Install = "Please be aware of disconnection to ressources such as network shares during install.`n`nPlease save your work before continuing as the following applications will be closed automatically."
            ...
            DialogMessageNoProcesses = @{
                Install = "Please be aware of disconnection to ressources such as network shares during install.`n`nPlease select Install to continue with the installation."
